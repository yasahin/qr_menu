...
!function (NioApp, $) {
    ...
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var def = {
          ...
          language: {
            search: "",
            searchPlaceholder: "Birşeyler yazın...",
            ...
            zeroRecords: "Gösterilecek bir kayıt bulunamadı !",
            paginate: {
              "first": "İlk",
              "last": "Son",
              "next": "Sonraki",
  ...
  NioApp.ModeSwitch = function () {
    ...
    toggle.on('click', function (e) {
      ...
      var current_user_id = $body.attr('current-user');
      var csrf_token = $body.attr('csrf-token');
      var dark_switch_url = $body.attr('dark-switch-url');
      ...
      if($body.hasClass('dark-mode')){
        ...
        data.append("dark_mode_state",dark_mode_state);
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response){
                    console.log("SYSTEM -> Kullanıcının Karanlık Mod Ayarı Kayıt Edildi !");
                }
            },
        });
  ...
  NioApp.BS.init = function () {
    ...
    $.fn.datepicker.dates['tr'] = {
        ...
        monthsShort: ["Oca", "Şub", "Mar", "Nis", "May", "Haz", "Tem", "Ağu", "Eyl", "Eki", "Kas", "Arl"],
        today: "Bugün",
        clear: "Temizle",
        format: "dd.mm.yyyy",
