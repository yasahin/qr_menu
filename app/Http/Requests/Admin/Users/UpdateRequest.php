...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(){
        return [
            ...
            'telefon' => 'required|min:10|max:11|unique:admin_users,telefon,'.$this->id,
            'dogum_tarihi' => 'nullable|max:100',
            'adres' => 'nullable',
            'eposta' => 'required|email|max:200|unique:admin_users,eposta,'.$this->id,
            'sifre' => 'nullable|confirmed',
            'sifre_confirmation' => 'nullable',
            'auth' => 'required',
        ];
    }
