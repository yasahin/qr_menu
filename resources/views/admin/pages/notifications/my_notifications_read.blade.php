...
@section('title') Okunmuş Bildirimlerim @endsection
@section('content')
    <div class="nk-content-body">
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between g-3">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Okunmuş Bildirimlerim </h3>
                </div>
            </div>
        </div><!-- .nk-block-head -->
                        ...
                        <div class="card-inner">
                            <div class="nk-block">
                                <div class="nk-block-head">
                                    <h5 class="title">Okunmuş Bildirimlerim </h5>
                                </div><!-- .nk-block-head -->
                                <div class="nk-block-body">

                                    @if(count(getAllMyReadNotifications()) > 0)

                                        <a href="{{ route('admin.my_notifications.list.read.clear') }}" class="btn btn-primary"> Hepsini Temizle</a>

                                        @foreach(getAllMyReadNotifications() as $ntf)
