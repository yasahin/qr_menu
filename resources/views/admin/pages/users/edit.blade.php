            ...
            <div class="card card-preview">
                <div class="card-inner">
                    <div class="preview-block">
                        <form action="{{ route('admin.users.list.edit_store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gy-4">
                                <div class="col-sm-6">
                                    <div class="user-avatar bg-dim-primary d-none d-sm-flex" style="height: 75px; width: 75px; margin-bottom: 20px;">
                                        {!! $User->getProfilResmi() !!}
                                    </div>
                                    <!-- [profil_resmi] -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" value="{{ $User->ad }}" class="form-control {{ CheckInput("ad",$errors) }}" name="ad" id="ad" placeholder="Ad giriniz">
                                        </div>
                                    </div>
                                    <!-- [soyad]* -->
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" value="{{ $User->soyad }}" class="form-control {{ CheckInput("soyad",$errors) }}" name="soyad" id="soyad" placeholder="Soyad giriniz">
                                        </div>
                                    </div>
                                    <!-- [telefon]* -->
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" value="{{ $User->telefon }}" class="form-control {{ CheckInput("telefon",$errors) }}" name="telefon" id="telefon" placeholder="+90xxxxxxxxxx">
                                        </div>
                                    </div>
                                    <!-- [dogum_tarihi] -->
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="text" value="{{ $User->dogum_tarihi }}" class="form-control date-picker {{ CheckInput("dogum_tarihi",$errors) }}" id="dogum_tarihi" name="dogum_tarihi" data-date-format="dd.mm.yyyy">
                                        </div>
                                    </div>
                                    <!-- [adres] -->
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <textarea class="form-control {{ CheckInput("adres",$errors) }}" name="adres" id="adres" rows="2">{{ $User->adres }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select form-control form-control-lg {{ CheckInput("auth",$errors) }}" name="auth" id="auth" data-search="on">
                                                @foreach(getAllAuths() as $auth)
                                                    <option value="{{ $auth->id }}" @if($User->auth_id == $auth->id) selected @endif>{{ $auth->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="text" value="{{ $User->eposta }}" class="form-control {{ CheckInput("eposta",$errors) }}" name="eposta" id="eposta" placeholder="E-Posta giriniz">
                                        </div>
                                    </div>
                                    <!-- [sifre]* -->
                                    <div class="form-group">
