    ...
    <tr>
        <td class="py-5">
            ...
            <table class="email-body">
                ...
                <tr>
                    <td class="heading">
                        <h2 class="email-heading">E-Posta Adresini Doğrula</h2>
                    </td>
                </tr>
                <tr>
                    <td class="content">
                        <p>Merhaba {{ @$user->ad }},</p>
                        <p>Hoş geldin! <br> Panelin bütün özelliklerinden faydalanmak için hesabını onaylamalısın.</p>
                        <p>Hesabını onaylamak için aşağıdaki linke tıkla ve {{ config("app.name") }} Panel in bütün özelliklerinden faydalan.</p>
                        <p class="mb-4">Bu link 1 saat boyunca geçerlidir. Fazla vakit kaybetmemen gerek.</p>
                        <a href="{{ route("admin.account_verify",$user->token) }}" class="email-btn">E-POSTA'YI DOĞRULA</a>
                    </td>
                </tr>
                <tr>
                    <td class="or_yer">
                        <h4 class="email-heading-s2">YADA</h4>
                        <p>Bazı tarayıcılarda link bazen çalışmayabilir bunun için bunu kullanabilirsin :</p>
                        <a href="{{ route("admin.account_verify",$user->token) }}" class="link-block">{{ route("admin.account_verify",$user->token) }}</a>
                    </td>
                </tr>
                <tr>
                    <td class="bottom_yer">
                        <p>E-Posta adresinizi zaten doğruladıysanız bu mesajı dikkate almayın.</p>
                        <p class="email-note">
