    ...
    <tr>
        <td class="py-5">
            ...
            <table class="email-body">
                ...
                <tr>
                    <td class="heading">
                        <h2 class="email-heading">Şifre Sıfırlama</h2>
                    </td>
                </tr>
                <tr>
                    <td class="content">
                        <p>Merhaba {{ @$user->ad }},</p>
                        <p>Hesabının şifresini değiştirmek için aşağıdaki bağlantıyı kullanabilirsin.</p>
                        <a href="{{ route("admin.change_password",$user->token) }}" class="email-btn">ŞİFREMİ SIFIRLA</a>
                    </td>
                </tr>
                <tr>
                    <td class="or_yer">
                        ...
                        <a href="{{ route("admin.change_password",$user->token) }}" class="link-block">{{ route("admin.change_password",$user->token) }}</a>
                    </td>
                </tr>
                <tr>
                    <td class="bottom_yer">
                        <p>Şifrenizi zaten sıfırladıysanız bu mesajı dikkate almayın.</p>
                        <p class="email-note">
