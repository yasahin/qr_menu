...
<head>
    <meta charset="UTF-8">
    <title>İki Adımlı Kimlik Doğrulama</title>
    <style type="text/css">
    ...
    <tr>
        <td class="py-5">
            ...
            <table class="email-body">
                ...
                <tr>
                    <td class="heading">
                        <h2 class="email-heading">İki Adımlı Kimlik Doğrulama</h2>
                    </td>
                </tr>
                <tr>
                    <td class="content">
                        <p>
                            Merhaba {{ $user->ad }},
                            <br>
                            Hesabına giriş yapmak için aşağıdaki kodu kullanabilirsin.
                        </p>
                        <h1 style="color: black;">{{ Cache::get($user->token) }}</h1>
                    </td>
                </tr>
                <tr>
                    <td class="bottom_yer">
