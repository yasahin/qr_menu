...
<head>
    <meta charset="utf-8">
    <meta name="author" content="{{ config("settings.admin.author_name") }}">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Yönetmeye kaldığın yerden devam et.">
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="{{ asset('admin/images/favicon.png') }}">
    <!-- Page Title  -->
    <title>{{ config("app.name") }} | Yönetim Paneline Giriş Yap</title>
    <!-- StyleSheets  -->
                        ...
                        <div class="card-inner card-inner-lg">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">Giriş Yap</h4>
                                    <div class="nk-block-des">
                                        <p>Yönetmeye kaldığın yerden devam et.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form action="{{ route("admin.login.logged") }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        ...
                                        <a class="link link-primary link-sm" href="{{ route('admin.login.forgot_password') }}">Şifremi unuttum ?</a>
                                    </div>
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="password" name="sifre" class="form-control form-control-lg {{ CheckInput("sifre",$errors) }}" id="password" placeholder="Şifrenizi giriniz">
                                    </div>
                                </div>
                                <div class="form-group">
